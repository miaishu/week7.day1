...
public class ServiceNowPage extends BaseClass_ServiceNowParallel {
	public ServiceNowPage(RemoteWebDriver driver) {
		this.driver=driver;
	}
	...
	public ServiceNowPage enterIncidentNumberForAssign() {
		driver.findElement(By.xpath("//input[@placeholder='Search']")).sendKeys("INC0010029",Keys.ENTER);
		return this;
	}
	
	public ServiceNowPage enterIncidentNumberForUpdate() {
		driver.findElement(By.xpath("//input[@placeholder='Search']")).sendKeys("INC0010065",Keys.ENTER);
		return this;
	}
	public ServiceNowPage enterIncidentNumberForDelete() {
		driver.findElement(By.xpath("//input[@placeholder='Search']")).sendKeys("INC0010097",Keys.ENTER);
		return this;
	}
