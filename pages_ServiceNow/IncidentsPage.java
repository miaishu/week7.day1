...
public class IncidentsPage extends BaseClass_ServiceNow{
	...
	public void verifyUpdatedIncident() {
		driver.findElement(By.xpath("//input[@class='form-control']")).sendKeys("INC0010095");
	...
	public void verifyDeletedIncident() {
		...
		driver.findElement(By.xpath("//input[@class='form-control']")).sendKeys("INC0010094");
